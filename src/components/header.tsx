  ...
  return (
    <>
      <header className="d-flex flex-wrap justify-content-center p-3 mb-4 border-bottom">
        ...
        >
          <span className="display-5 link-body-emphasis mb-1 fs-2">
            <strong>w3earth</strong>
          </span>
        </a>
        <span className="d-flex align-items-center p-1 pe-2 bg-danger-subtle border border-danger-subtle rounded-pill">
          <img
            className="rounded-circle me-1"
            width="24"
            height="24"
            src="https://w3earth.link/assets/images/logo/projects-logo009.png"
            alt=""
          />
          <span className="badge text-danger-emphasis">Movie Review</span>
        </span>
        <ul
          className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"
          style={{ background: "#f3e5f3" }}
        >
        ...
        <ul className="nav nav-pills">
          ...
          <li className="nav-item">
            <Link className="btn btn-outline-dark me-2" to="/contact">
              Contact
            </Link>
          </li>
        </ul>
